...
" } "))
        ...
        MainWindow.setTabOrder(self.headLineEdit, self.capacityLineEdit)
        MainWindow.setTabOrder(self.capacityLineEdit, self.transitTimeLineEdit)
        MainWindow.setTabOrder(self.transitTimeLineEdit, self.updateEdgeButton)
        MainWindow.setTabOrder(self.updateEdgeButton, self.deleteEdgeButton)
        MainWindow.setTabOrder(self.deleteEdgeButton, self.nodeNameLineEdit)
        MainWindow.setTabOrder(self.nodeNameLineEdit, self.nodeXLineEdit)
        MainWindow.setTabOrder(self.nodeXLineEdit, self.nodeYLineEdit)
        MainWindow.setTabOrder(self.nodeYLineEdit, self.updateNodeButton)
        MainWindow.setTabOrder(self.updateNodeButton, self.deleteNodeButton)
        MainWindow.setTabOrder(self.deleteNodeButton, self.edgeSelectionListWidget)
        MainWindow.setTabOrder(self.edgeSelectionListWidget, self.nodeSelectionListWidget)
        MainWindow.setTabOrder(self.nodeSelectionListWidget, self.outputDirectoryLineEdit)
        ...
        MainWindow.setTabOrder(self.cleanUpCheckBox, self.activateTimeoutCheckBox)
        MainWindow.setTabOrder(self.activateTimeoutCheckBox, self.timeoutLineEdit)
        MainWindow.setTabOrder(self.timeoutLineEdit, self.inflowLineEdit)
        MainWindow.setTabOrder(self.inflowLineEdit, self.intervalsLineEdit)
        MainWindow.setTabOrder(self.intervalsLineEdit, self.logPlainTextEdit)
        MainWindow.setTabOrder(self.logPlainTextEdit, self.computeFlowPushButton)
        MainWindow.setTabOrder(self.computeFlowPushButton, self.timeSlider)
        MainWindow.setTabOrder(self.timeSlider, self.animationStartLineEdit)
        MainWindow.setTabOrder(self.animationStartLineEdit, self.animationEndLineEdit)
        MainWindow.setTabOrder(self.animationEndLineEdit, self.generateAnimationPushButton)
        MainWindow.setTabOrder(self.generateAnimationPushButton, self.playPushButton)
        MainWindow.setTabOrder(self.playPushButton, self.pausePushButton)
        MainWindow.setTabOrder(self.pausePushButton, self.stopPushButton)
        MainWindow.setTabOrder(self.stopPushButton, self.exportComboBox)
        MainWindow.setTabOrder(self.exportComboBox, self.exportDiagramPushButton)
        MainWindow.setTabOrder(self.exportDiagramPushButton, self.setTimeLineEdit)
        MainWindow.setTabOrder(self.setTimeLineEdit, self.setTimePushButton)
        MainWindow.setTabOrder(self.setTimePushButton, self.intervalsListWidget)
        MainWindow.setTabOrder(self.intervalsListWidget, self.showEdgesWithoutFlowCheckBox)
        MainWindow.setTabOrder(self.showEdgesWithoutFlowCheckBox, self.computeIntervalPushButton)
