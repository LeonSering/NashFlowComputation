...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1164, 1122)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(MainWindow.sizePolicy().hasHeightForWidth())
        MainWindow.setSizePolicy(sizePolicy)
        MainWindow.setMinimumSize(QtCore.QSize(1164, 1122))
...
" } "))
        ...
        self.groupBox_5.setGeometry(QtCore.QRect(670, 10, 461, 371))
...
" } "))
        ...
        self.plotEdgeFrame = QtGui.QFrame(self.groupBox_5)
        self.plotEdgeFrame.setGeometry(QtCore.QRect(10, 20, 441, 341))
        self.plotEdgeFrame.setFrameShape(QtGui.QFrame.Box)
        self.plotEdgeFrame.setObjectName(_fromUtf8("plotEdgeFrame"))
        self.groupBox_6 = QtGui.QGroupBox(self.tab_2)
        self.groupBox_6.setGeometry(QtCore.QRect(670, 380, 461, 401))
...
" } "))
        ...
        self.plotNodeLabelFrame.setGeometry(QtCore.QRect(10, 20, 441, 341))
        ...
        self.setPlotRangePushButton = QtGui.QPushButton(self.groupBox_6)
        self.setPlotRangePushButton.setGeometry(QtCore.QRect(160, 370, 101, 21))
        self.setPlotRangePushButton.setObjectName(_fromUtf8("setPlotRangePushButton"))
        self.plotUpperBoundLineEdit = QtGui.QLineEdit(self.groupBox_6)
        self.plotUpperBoundLineEdit.setGeometry(QtCore.QRect(120, 370, 31, 21))
        self.plotUpperBoundLineEdit.setText(_fromUtf8(""))
        self.plotUpperBoundLineEdit.setObjectName(_fromUtf8("plotUpperBoundLineEdit"))
        self.label_16 = QtGui.QLabel(self.groupBox_6)
        self.label_16.setGeometry(QtCore.QRect(110, 370, 16, 21))
        self.label_16.setObjectName(_fromUtf8("label_16"))
        self.label_15 = QtGui.QLabel(self.groupBox_6)
        self.label_15.setGeometry(QtCore.QRect(10, 370, 61, 21))
        self.label_15.setObjectName(_fromUtf8("label_15"))
        self.plotLowerBoundLineEdit = QtGui.QLineEdit(self.groupBox_6)
        self.plotLowerBoundLineEdit.setGeometry(QtCore.QRect(70, 370, 31, 21))
        self.plotLowerBoundLineEdit.setObjectName(_fromUtf8("plotLowerBoundLineEdit"))
        self.groupBox_4 = QtGui.QGroupBox(self.tab_2)
        self.groupBox_4.setGeometry(QtCore.QRect(0, 580, 651, 431))
...
" } "))
        ...
        self.intervalsListWidget.raise_()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_5.setTitle(_translate("MainWindow", "Edge cumulative inflow/outflow and queue size", None))
        self.groupBox_6.setTitle(_translate("MainWindow", "Dynamic shortest path distances", None))
        self.setPlotRangePushButton.setText(_translate("MainWindow", "Set", None))
        self.label_16.setText(_translate("MainWindow", "-", None))
        self.label_15.setText(_translate("MainWindow", "Range:", None))
        self.plotLowerBoundLineEdit.setText(_translate("MainWindow", "0", None))
