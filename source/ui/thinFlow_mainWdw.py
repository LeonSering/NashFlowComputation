...
" } "))
        ...
        self.formLayout_3.setWidget(3, QtGui.QFormLayout.FieldRole, self.capacityLineEdit_spillback)
        ...
        self.formLayout_3.setWidget(2, QtGui.QFormLayout.FieldRole, self.boundLineEdit_spillback)
