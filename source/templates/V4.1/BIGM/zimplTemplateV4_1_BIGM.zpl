...
var l[V] real >= 0 <= B;
var x[E] real >= 0;
var z[E_0 without E_star] real >= 0 <= 1;
var alp[E_0 without E_star] real;

#OBJECTIVE
maximize labels: sum <v,w> in (E_0 without E_star): alp[v,w];
...
subto quad: forall <v,w> in E_0 without E_star do
                        alp[v,w] == (z[v,w]*(z[v,w]-1));
